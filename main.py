...
if __name__ == "__main__":
    ...
    if (args.dataset == "all") or (args.dataset == "ALL"):
        print(f"Total datasets: {len(univariate)}") # Output: Total datasets: 128
        for i, dataset in enumerate(univariate):
            print(f"Running {args.classifier} on {dataset} dataset. {i+1}/{len(univariate)}.")
